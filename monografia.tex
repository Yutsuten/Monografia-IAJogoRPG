...
\section{INTRODUÇÃO}
	...
	Isto foi feito utilizando um sistema chamado \textit{Goal Oriented Action Planning} (Planejamento de Ações Orientado a Objetivo),
...
\section{CONCEITOS}
	...
	No entanto, o \textit{crossover} não necessariamente ocorre sempre.
...
\section{O JOGO}
	...
	que copia os 2 com melhor \textit{fitness} da população antiga para lá sem nenhuma modificação.
	...
	e neste momento o \textit{script} de Rede Neural do seu time entra em ação 6 vezes,
	...
	todas as notas são somadas para obter-se o \textit{fitness} final da equipe.
