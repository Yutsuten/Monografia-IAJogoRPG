...
\chapter{CONCEITOS}
	...
	\begin{figure}[ht!]
		...
		\centering
		\includegraphics[scale=0.55]{img/ActivationFunctions.png}\\
		\vspace{0.5mm}
		\source{Baseado em Turing Finance.}
	...
	\begin{figure}[ht!]
		...
		\includegraphics[scale=0.7]{img/Roulette.jpg}\\
		\vspace{0.5mm}
...
%	De acordo com \citep{unitySite}, blah blah	
	
%	De acordo com \citep{unityGames}, blah blah
	
%	Figura 3: \cite{unityInterface}
