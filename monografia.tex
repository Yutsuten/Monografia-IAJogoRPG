...
\section{CONCEITOS}
	...
	A escolha da função de saída dos neurônios também tem bastante influência na convergência da Rede Neural Artificial.
	...
	\begin{figure}[ht!]
		\caption{Funções de Ativação comuns na RNA}
		\centering
	...
	que podem ser visualizadas na Figura \ref{fig:activationFunctions}.
	...
	pode-se utilizar a função linear (a) na camada de saída.
