...
\chapter{CONCEITOS}
	...
	Uma breve descrição e alguns exemplos serão feitos sobre cada um deles.
		...
		\begin{figure}[ht!]
			...
			\centering
			\includegraphics[scale=0.4]{img/marioworld.jpg}\\
			\vspace{0.5mm}
		...
		Estes jogos se contrastam com os jogos de ação por não precisarem de "reflexo"{} ou "ação"{} por parte do jogador.
		Jogos \textit{point-and-click} se encaixam nesta categoria,
		que muitas vezes tem pequenos quebra-cabeças a serem resolvidos.
		Um exemplo \textit{King's Quest} \cite{gameGenres}.
		Também existem os \textit{Visual Novels},
		que normalmente possuem gráficos estáticos,
		e o jogador tem escolhas durante a história,
		...
		\begin{figure}[ht!]
			...
			\centering
			\includegraphics[scale=0.7]{img/visual_novel.jpg}\\
			\vspace{0.5mm}
		...
		\begin{figure}[ht!]
			...
			\centering
			\includegraphics[scale=0.85]{img/formula1.jpg}\\
			\vspace{0.5mm}
